...
// onNewToken : 토큰 생성 메서드
// onMessageReceived : 메세지 수신 메서드. 메세지에 제목, 내용 있는지 검사 후 문제 없으면 sendNotification 호출
// sendNotification : 알림 생성. 아이콘/알림소리 등
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(remoteMessage: RemoteMessage) {
        ...
        // 알림 채널 이름
        val channelId = getString(R.string.firebase_name)
