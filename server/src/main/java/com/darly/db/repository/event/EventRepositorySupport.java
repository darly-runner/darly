...
public class EventRepositorySupport {
    ...
    public List<EventList> findEvents() {
        return jpaQueryFactory.select(Projections.constructor(EventList.class, qEvent.eventTitle, qEvent.eventContent, qEvent.eventImage, qEvent.user.userNickname, qEvent.eventDate))
                .from(qEvent, qUser)
